...
const Myprofile = () => {
    ...
    const dept = FindDepartment(currentuser.department, department);
                    ...
                    <table className='py-2 block w-full border-separate capitalize border-spacing-y-2 border-spacing-x-4 px-4'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <Link to={`../employees/view/${currentuser?.manager}`}>{currentuser?.managerName}</Link>
                            ...
                            <tr>
                                ...
                                <td>{currentuser.jobmode}</td>
                            </tr>
                            <tr>
                                <td className="font-semibold text-black">Job Status:</td>
                                <td>{currentuser.jobstatus}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
